...
import {
  JsonSchemaNodeRow,
  type JsonSchemaNodeRowProps,
} from './JsonSchemaNodeRow'
          ...
          <>
            ...
            {Array.isArray(value.properties) && value.properties.length > 0 ? (
              <JsonSchemaNodeWrapper
                shouldExpand={!!restProps.fromRef || shouldExpand}>
                {value.properties.map((propSchema, i) => {
                  ...
                  return (
                    <JsonSchemaNode
                      ...
                      value={propSchema}
                      onChange={(changValue) => {
                        const newProperties = value.properties!.map(
                          (prop, idx) => {
                            if (idx === i && changValue) {
                              return changValue
                            }
              ...
              <div
                ...
                style={{
                  paddingLeft:
                    getNodeLevelInfo([...fieldPath, KEY_PROPERTIES, '0'])
                      .indentWidth + INDENT,
                }}>
