...
export function JsonSchemaNodeRow(props: JsonSchemaNodeRowProps) {
  ...
  const { readOnly, expandedKeys, onExpand, extraColumns } =
  ...
  return (
    <div className={styles.row.main}>
      ...
      <div
        className={`${styles.row.col} ${styles.row.type} ${styles.row.colHover}`}>
        <DataTypeSelect
            ...
            switch (oldType) {
              ...
              default: {
                if (newType === SchemaType.Array) {
                  ...
                  onExpand?.(
                    expandedKeys ? [...expandedKeys, pathString] : [pathString],
                  )
                }
      ...
      <div
        className={`${styles.row.col} ${styles.row.title} ${styles.row.colHover}`}>
        <Input
          disabled={disabled}
          placeholder='中文名'
          value={displayName}
      ...
      <div
        className={`${styles.row.col} ${styles.row.description} ${styles.row.colHover}`}>
        <Input
          disabled={disabled}
          placeholder='说明'
          value={description}
