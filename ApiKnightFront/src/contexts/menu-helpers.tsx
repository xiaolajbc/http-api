 ...
 * @Date: 2024-12-14 23:27:30
 * @LastEditors: xiaolajiaobc 13456820+xiaolajiaobc@user.noreply.gitee.com
 * @LastEditTime: 2024-12-15 11:54:32
 * @FilePath: \ApiKnight\ApiKnightFront\src\contexts\menu-helpers.tsx
...
interface MenuHelpers {
  ...
  /** 更新一个菜单项的信息。 */
  updateMenuItem: (
    menuData: Partial<ApiMenuData> & Pick<ApiMenuData, 'id'>,
  ) => void
  /** 从回收站中恢复菜单项。 */
  restoreMenuItem: (
...
interface MenuHelpersContextData extends MenuHelpers {
  ...
  setMenuSearchWord?: React.Dispatch<
    React.SetStateAction<MenuHelpersContextData['menuSearchWord']>
  >
